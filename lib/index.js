...
class HoprEthereum {
    ...
    static async create(db, seed, options) {
        ...
        const coreConnector = new HoprEthereum(db, web3, chainId, network, hoprChannels, hoprToken, { debug: (options === null || options === void 0 ? void 0 : options.debug) || false }, privateKey, publicKey);
