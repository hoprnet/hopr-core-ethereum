...
class TicketFactory {
    ...
    async submit(signedTicket) {
        ...
        const transaction = await signTransaction(hoprChannels.methods.redeemTicket(hopr_utils_1.u8aToHex(pre_image), hopr_utils_1.u8aToHex(ticket.channelId), hopr_utils_1.u8aToHex(counterPartySecret), hopr_utils_1.u8aToHex(secret), ticket.amount.toString(), hopr_utils_1.u8aToHex(ticket.winProb), hopr_utils_1.u8aToHex(r), hopr_utils_1.u8aToHex(s), v), {
